...
public class WithdrawAmountRequestDto implements RequestDto {
    @Serial
    private static final long serialVersionUID = 6939685098267757690L;
    ...
    public WithdrawAmountRequestDto(Double amount) {
        this.amount = amount;
    }
